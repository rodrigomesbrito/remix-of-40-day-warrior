    ...
    <div className="space-y-8">
      ...
      <div className="bg-card border border-border rounded-lg p-5 shadow-card">
        <div className="flex items-baseline justify-between mb-2">
          <span className="text-xs uppercase tracking-widest text-muted-foreground">Consistência</span>
      ...
      <div className="bg-gradient-blood border border-primary/40 rounded-lg p-6 shadow-deep">
